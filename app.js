...
let productsRendering = (data) => {
    ...
    data.forEach(p => {
        ...
        <div class="product border">
                  ...
                  <h5 class="ms-2"><a href="./productDetails.html?pid=${p.id-1}">${p.title}</a></h5>
                  ...
                  <button class="btn btn-danger m-2" onclick="addToCart(${p.id-1})">add to cart <i class="bi bi-cart-plus"></i></button>
